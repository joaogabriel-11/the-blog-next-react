...
```bash
git clone https://github.com/joaogabriel-11/the-blog-next-react.git
```
...
This project was developed to practice and improve knowledge in:
...
The application was designed to provide a great experience on:
